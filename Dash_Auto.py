...
# İNCELEME1: Düzeni temizleyin ve geri arama yürütülene kadar istisnayı görüntüleme
...
app.layout = html.Div(children=[
     ...
     html.Div([
                   ...
                   # Selected Drive tekerlekleri için açılır yardımcı metin eklemek için ilk iç bölüm
                    html.Div(
                            #TASK 3B
                            [
                    ...
                    #TASK 3C
                    # Dropdown labellerini oluşturalım.
